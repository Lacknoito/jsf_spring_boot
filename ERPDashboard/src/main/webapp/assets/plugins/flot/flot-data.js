...
var plot = $.plot("#flot-chart-1", [getRandomData()], {
    series: {
...
$(function () {
    ...
    , }, {
        ...
        , color: "#e91e63"
    , }];
    var plotObj = $.plot($("#flot-chart-3"), data, {
        series: {
            pie: {
                innerRadius: 0.5
                , show: true
...
$(function () {
    ...
    $.plot($("#flot-chart-5"), [barData], barOptions);
});
