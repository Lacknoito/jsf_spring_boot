...
Morris.Area({
        ...
        pointSize: 3,
        fillOpacity: 0,
        pointStrokeColors:['#ffa200', '#0acae2', '#ff3e43'],
        behaveLikeLine: true,
...
Morris.Area({
        ...
        pointSize: 0,
        fillOpacity: .4,
        pointStrokeColors:['#0acae2', '#292929'],
        behaveLikeLine: true,
        gridLineColor: '#e0e0e0',
        lineWidth: 0,
        smooth: false,
        hideHover: 'auto',
        lineColors: ['#0acae2', '#292929'],
        resize: true
...
// Morris bar chart
    Morris.Bar({
        ...
        ykeys: ['a', 'b', 'c'],
        labels: ['A', 'B', 'C'],
        barColors:['#4caf50', '#292929', '#0acae2'],
        hideHover: 'auto',
        gridLineColor: '#eef0f2',
        resize: true
    });
